...
class ServiceController extends Controller
{
    ...
    public function index()
    {
        ...
        //die;
        return view('adminView.services.index',compact('userServices'));
    }
    ...
    {    
        ...
        $member = Member::where('user_id',Auth::user()->id)->first();
        return view('adminView.services.show',compact('service','member'));
    }
 ...
 //            'to'     =>  'sometimes|nullable|date_format:Y-m-d|after_or_equal:from',
    ...
    public function members_list(){
        ...
        return view('adminView.member.index',compact('members','services'));
    }
    ...
    public function members_list_fetch(Request $request){
        ...
        $members = $members->get();
        return view('adminView.member.table',compact('members'));
    }
    ...
    public function member_services($id){
        ...
        return view('adminView.member.service_table',compact('member_services'));
    }
    ...
    public function new_members_list()
    {
        ...
        return view('adminView.new_memeber.new_member',compact('members'));
    }
    ...
    public function new_members_list_fetch($id)
    {
        ...
        //return $service;
        return view('adminView.new_memeber.member_show_detail',compact('service'));
    }
