...
// return $data;
    ...
    public function service_payment($id){
      ...
      $userservice = Member::find($id);

      $service = Service::find($id);

      return view('admin::payments.form_payment',compact('userservice','service'));
    ...
    public function iap_membership_tenth_doc(Request $request){
        ...
        return redirect('/services/iap_membership_twelve')->with('success','10th Marksheet Uploaded Successfully.');
       //return view('admin::services.forms.iap_membership_twelve');

    }

    public function iap_membership_twelve(){
        $member = Member::where('user_id',Auth::user()->id)->first();
        return view('admin::services.forms.iap_membership_twelve',compact('member'));
    ...
    public function iap_membership_twelve_doc(Request $request){   
        ...
        $member->update($data);
        $doc_status = update_doc_status();
        return redirect('/services/iap_membership_intern')->with('success','12th Marksheet uploaded Successfully.');
    }


    public function iap_membership_intern(){
        $member = Member::where('user_id',Auth::user()->id)->first();
        return view('admin::services.forms.iap_membership_intern',compact('member'));
    }
    ...
    public function iap_membership_intern_doc(Request $request){   
        ...
        $member->update($data);
        $doc_status = update_doc_status();
        return redirect('/services/iap_membership_bpt')->with('success','Internship Certificate uploaded Successfully.');
    }

    public function iap_membership_bpt(){
         $member = Member::where('user_id',Auth::user()->id)->first();
        return view('admin::services.forms.iap_membership_bpt',compact('member'));
    ...
    public function iap_membership_bpt_doc(Request $request){   
        ...
        $member->update($data);
        $doc_status = update_doc_status();
        return redirect('/services/iap_membership_mpt')->with('success','BPT Document uploaded Successfully.');
    }

    public function iap_membership_mpt(){
        $member = Member::where('user_id',Auth::user()->id)->first();
        return view('admin::services.forms.iap_membership_mpt',compact('member'));
    ...
    public function iap_membership_mpt_doc(Request $request){   
        ...
        $member->update($data);
        return redirect('/services/iap_membership_govprf1')->with('success','Master Degree Document uploaded successfully');
    }

    public function iap_membership_govprf1(){
        $member = Member::where('user_id',Auth::user()->id)->first();
        return view('admin::services.forms.iap_membership_govprf1',compact('member'));
    ...
    public function iap_membership_govprf1_doc(Request $request){   
        ...
        $member->update($data);
        $doc_status = update_doc_status();
        return redirect('/services/iap_membership_govprf2')->with('success','Goverment proof Document uploaded Successfully.');
    }

    public function iap_membership_govprf2(){
        $member = Member::where('user_id',Auth::user()->id)->first();
        return view('admin::services.forms.iap_membership_govprf2',compact('member'));
    ...
    public function iap_membership_govprf2_doc(Request $request){   
        ...
        $member->update($data);
        $doc_status = update_doc_status();
        return redirect('/services/iap_membership_other')->with('success','Goverment proof Document uploaded Successfully.');
    }

    public function iap_membership_other(){
        $member = Member::where('user_id',Auth::user()->id)->first();
        return view('admin::services.forms.iap_membership_other',compact('member'));
    ...
    public function iap_membership_other_doc(Request $request){   
        ...
        // $users = User::whereRoleIs('member_admin')->get();
        // Notification::send($users, new NotifyMessage($message));
        return redirect('/service')->with('success','Other Document uploaded Successfully');
