...
class ApprovalController extends Controller
{
    ...
    public function profile(){
        ...
        return view('approval.approval.profile',compact('members'));
    }

    public function profile_show($id){
        $member = Member::with('college')->where('user_id',$id)->first();
        return view('approval.approval.profile_show',compact('member'));
    }
    ...
    public function qualifications(){
		...
		return view('approval.approval.qualification',compact('members'));
    }

    public function qualification_show($id){
    	$qualifications = MemberQual::where('status','P')->where('user_id',$id)->get();
  		return view('approval.approval.qualification_show',compact('qualifications'));
    }
    ...
    public function specialization(){
        ...
        $members = Member::whereIn('user_id',$member_ids)->get(); 
        // return $members;
        return view('approval.approval.specialization',compact('members'));
    }
    public function specialization_show($id){
        ...
        // return $specs;
        $user_id = $id;
        return view('approval.approval.specialization_show',compact('specs','user_id'));
    ...
    public function service_request($status =null,$payment_status = null){    
        ...
        // dd($services);
        return view('approval.approval.services.service_request',compact('services'));
    }
    ...
    public function service_request_filter(Request $request){      
        ...
        return view('approval.approval.services.service_req_table',compact('services'));
    }
    public function service_show($id){        
        $service = UserService::with(['service','member'])->where('id',$id)->first();
    //   return $service;
        return view('approval.approval.services.show_service',compact('service'));
    }
