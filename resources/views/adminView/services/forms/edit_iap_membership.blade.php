...
<div class="row">
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-body">
				{{Form::open(array('url' => '/service/iap_membership/update/'.$member->id,'method' => 'POST','enctype' => 'multipart/form-data'))}}
					@method('Patch')
					<div class="row mt-3">	
						@if($service->id == '14')
							@if($member->college_code !=null)
		                   	...
		                   	@else
			                    <div class="col-md-6 form-group"  id="text_college" >
					...
					<div class="row">
						...
						<div class="col-md-4 form-group">
		                   ...
		                   {{--  @if($member->address_proof_doc !='')
								<img src="{{asset('storage/'.$member->address_proof_doc)}}"  alt="Profile Photo" class="mt-2" style="height: 20px; width: 20px">
							@endif --}}
						</div>	
						<div class="col-md-4 form-group">
							<br>
					...
					<div class="row">
						<div class="col-md-12">
							<table class="table">
								...
								<tbody>
									<tr>
										<th>{{Form::label('signature','Applicant Signature',['class' => 'required'])}} </th>
										<th>{{ Form::file('signature',['class' => 'form-control','accept'=>"image/*","required" => "required"])}}
											@error('signature')
						                        <span class="text-danger" role="alert">
						                            <strong>{{ $message }}</strong>
						                        </span>
									...
									<tr>
										<th>{{Form::label('photo','Applicant Photo',['class' => 'required'])}} </th>
										<th>{{ Form::file('photo',['class' => 'form-control','accept'=>"image/*","required" => "required"])}}
										@error('photo')
					                        <span class="text-danger" role="alert">
					                            <strong>{{ $message }}</strong>
					                        </span>
									...
									<tr>
										<th> {{Form::label('ten_doc','10th Marksheet',['class' => 'required'])}}</th>
										<th>
										{{ Form::file('ten_doc',['class' => 'form-control','accept'=>"image/*","required" => "required"])}}
										@error('ten_doc')
					                        <span class="text-danger" role="alert">
					                            <strong>{{ $message }}</strong>
					                        </span>
										...
										@if($member->ten_doc !='')	
										<th>
											<a href="{{asset('storage/'.$member->ten_doc)}}" class="mt-1" style="overflow: hidden;"><i class="fa fa-eye"></i> {{file_name($member->ten_doc)}}
											</a>
									...
									<tr>
										<th> {{Form::label('twelve_doc','12th Marksheet',['class' => 'required'])}}</th>
										<th>
										{{ Form::file('twelve_doc',['class' => 'form-control','accept'=>"image/*","required" => "required"])}}
										@error('twelve_doc')
					                        <span class="text-danger" role="alert">
					                            <strong>{{ $message }}</strong>
					                        </span>
										...
										<th>
											<a href="{{asset('storage/'.$member->twelve_doc)}}" class="mt-1" style="overflow: hidden;"><i class="fa fa-eye"></i> {{file_name($member->twelve_doc)}}
											</a>
									...
									<tr>
										<th> {{Form::label('internship_doc','Internship Certificate',['class' => 'required'])}}</th>
										<th>
										{{ Form::file('internship_doc',['class' => 'form-control','accept'=>"image/*","required" => "required"])}}
										...
										<th>
											<a href="{{asset('storage/'.$member->internship_doc)}}" class="mt-1" style="overflow: hidden;"><i class="fa fa-eye"></i> {{file_name($member->internship_doc)}}
											</a>
									...
									<tr>
										<th> {{Form::label('bpt_doc','Bachelor of Physiotherapy (B.P.T.)',['class' => 'required'])}}</th>
										<th>
										{{ Form::file('bpt_doc',['class' => 'form-control','accept'=>"image/*","required" => "required"])}}
										@error('bpt_doc')
					                        <span class="text-danger" role="alert">
					                            <strong>{{ $message }}</strong>
					                        </span>
										...
										@if($member->bpt_doc !='')
										<th>
											<a href="{{asset('storage/'.$member->bpt_doc)}}" class="mt-1" style="overflow: hidden;"><i class="fa fa-eye"></i> {{file_name($member->bpt_doc)}}
											</a>
									...
									<tr>
										<th> {{Form::label('mpt_doc','Master of Physiotherapy (M.P.T.)')}}</th>
										<th>
										...
										@if($member->mpt_doc !='')
										<th>
											<a href="{{asset('storage/'.$member->mpt_doc)}}" class="mt-1" style="overflow: hidden;"><i class="fa fa-eye"></i> {{file_name($member->mpt_doc)}}
											</a>	
										</th>
										@endif
									</tr>
									<tr>
										<th> {{Form::label('gov_proof','Any Goverment Proof',['class' => 'required'])}}</th>
										<th>
										{{ Form::file('gov_proof',['class' => 'form-control','accept'=>"image/*","required" => "required"])}}
										@error('gov_proof')
					                        <span class="text-danger" role="alert">
					                            <strong>{{ $message }}</strong>
					                        </span>
									...
									<tr>
										<th> {{Form::label('gov_proof1','Any Goverment Proof',['class' => 'required'])}}</th>
										<th>
									...
									<tr>
										<th> {{Form::label('any_other_doc','Any Other Document',['class' => 'required'])}}</th>
										<th>
