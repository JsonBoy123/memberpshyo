	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<h5 class="card-title">Add Intership Qualification {{-- <a href="{{url('/qualification')}}" class="btn btn-sm btn-info pull-right">Back</a> --}}</h5>
			</div>
			<form action="{{url('/intern_qualification_create')}}" method="post" enctype="multipart/form-data">
			@csrf	
			<div class="card-body">
