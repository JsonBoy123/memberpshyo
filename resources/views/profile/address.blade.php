...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 ml-3 text-gray-800">Add address</h1>
</div>
<div class="row">
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-body">
							...
							<div class="card-body">	
								<div class="row">
									<div class="col-md-4 from-group">
										...
										<input type="text" name="addr" id="addr" class="form-control addr">
                    ...
                    @enderror
		                    ...
		                    @endforeach
									...
									<div class="col-md-4 from-group mt-2">
										...
										<select id="city" class="form-control" name="city_code">
		                </select>
									...
									<div class="col-md-4 from-group mt-2">	
										...
										<input type="text" name="zip" id="zip" class="form-control zip">
						...
						<div class="col-md-12 from-group mt-3">
							<div class="card">
								...
								<div class="row">
									...
									<div class="col-md-4 from-group">
										<label class="required">Address Line</label>
										<input type="text" name="addr1" id="addr1" class="form-control addr" >
                    ...
                    @enderror
		                    ...
		                    @endforeach
									...
									<div class="col-md-4 from-group">
										<label class="required">State Name:</label>
										<select id="state1" class="form-control" name="state_code1">
											<option></option>
		                </select>
									...
									<div class="col-md-4 from-group mt-2">
										<label class="required">City Name:</label>
										<select id="city1" class="form-control" name="city_code1">
		                </select>
									...
									<div class="col-md-4 from-group mt-2">
										<label class="required">Zip Code:</label>
										<input type="text" name="zip1" id="zip1" class="form-control zip">
...
<script>
    ...
    $("input#checker").bind("click",function(o){
      if($("input#checker:checked").length){
        ...
        $("#country1").val($("#country").val());
				...
				let click_state = $('#state').val();
				jQuery.ajax({
				url:'/click_state_box',
				type:'post',
				data:'click_state='+click_state+'&_token={{csrf_token()}}',
				success:function(result){
					//$("#state1").val(result);
					if(result){
            $("#state1").empty();
        ...
        let click_city = $('#city').val();
        
				jQuery.ajax({
				url:'/click_city_box',
				type:'post',
				data:'click_city='+click_city+'&_token={{csrf_token()}}',
				success:function(result){
					//$("#state1").val(result);
					if(result){
            $("#city1").empty();
  ...
  //     		jQuery.ajax({	
	 ...
	 //              $("#state_dropdown").append('<option>Select State</option>');
	 //              $.each(result,function(key,value){
